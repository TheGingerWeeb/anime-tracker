...
A real-time status monitoring dashboard for free anime streaming websites, built with a cyberpunk aesthetic. Track which sites are active, down, or unknown with live status checking and an admin panel.
